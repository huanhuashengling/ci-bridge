...
CREATE TABLE IF NOT EXISTS `bridge`.`students` (
  ...
  `parents_users_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`users_id`),
...
START TRANSACTION;
USE `bridge`;
INSERT INTO `bridge`.`students` (`users_id`, `edu_starting_date`, `city_student_number`, `national_student_number`, `gender`, `birth_date`, `classes_id`, `parents_users_id`) VALUES (4, '2011', NULL, NULL, 1, NULL, 2, 5);
