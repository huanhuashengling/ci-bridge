...
START TRANSACTION;
USE `bridge`;
INSERT INTO `bridge`.`evaluation_indexs` (`id`, `description`, `last_update_date`, `last_updated_by`, `courses_id`, `order_number`) VALUES (1, '你好吗', NULL, NULL, 1, 1);
INSERT INTO `bridge`.`evaluation_indexs` (`id`, `description`, `last_update_date`, `last_updated_by`, `courses_id`, `order_number`) VALUES (2, '我很好', NULL, NULL, 1, 2);
...
START TRANSACTION;
USE `bridge`;
INSERT INTO `bridge`.`evaluation_details` (`id`, `description`, `last_update_date`, `last_updated_by`, `evaluation_indexs_id`, `order_number`) VALUES (1, '你好', NULL, NULL, 1, 1);
INSERT INTO `bridge`.`evaluation_details` (`id`, `description`, `last_update_date`, `last_updated_by`, `evaluation_indexs_id`, `order_number`) VALUES (2, '我好', NULL, NULL, 2, 2);
